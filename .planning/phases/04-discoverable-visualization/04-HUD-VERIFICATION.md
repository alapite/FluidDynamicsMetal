...
Prior-phase macOS 26 host and physical-device two-finger checks remain deferred; Phase 3's accepted resample risk AR-03-01 is unchanged. CTRL-01 core control/input flow was approved by the user; unreported variants above remain explicit follow-ups.
